...
| 任务类型 | 必读文件 |
|----------|----------|
| **写代码前：多平台画质与性能定稿** | `AIDOC/global-info/knowledge/steering/godot/pre-development-defaults.md` |
| **启动全新游戏项目** | `AIDOC/global-info/knowledge/steering/godot/project-bootstrap.md` |
| **开发具体功能/模块的完整流程** | `AIDOC/global-info/knowledge/steering/godot/feature-development-flow.md` |
| **任务拆解与三要素格式** | `AIDOC/global-info/knowledge/steering/godot/task-representation.md` |
| **游戏类型蓝图（标准功能清单）** | `AIDOC/global-info/knowledge/steering/godot/game-type-blueprints.md` |
| **体验基准参考（手感参数范围）** | `AIDOC/global-info/knowledge/steering/godot/experience-benchmarks.md` |
| 执行开发工作流（双轨并行） | `AIDOC/global-info/knowledge/steering/godot/development-workflow.md` |
| 每步执行时的依赖检查和产出验证 | `AIDOC/global-info/knowledge/steering/godot/execution-protocol.md` |
| 2D/3D 分支路由规则 | `AIDOC/global-info/knowledge/steering/godot/branch-routing.md` |
| 资产管线（导入/生成/集成） | `AIDOC/global-info/knowledge/steering/godot/asset-pipeline.md` |
| 迭代优化（调试/性能/平衡） | `AIDOC/global-info/knowledge/steering/godot/iteration-workflow.md` |
| 多平台性能/画质预算 | `AIDOC/global-info/knowledge/steering/godot/performance-budget.md` |
...
| **Go 排查方法论**（排查优先级/高频陷阱/经验教训） | `AIDOC/global-info/knowledge/steering/go/go-debugging.md` |
...
> 游戏开发进入任何制作阶段前，必须执行 `AIDOC/global-info/knowledge/steering/godot/execution-protocol.md` 的门控检查。
> **系统模板索引与知识库写作原则**：`AIDOC/global-info/knowledge/templates/README.md`、`AIDOC/global-info/knowledge/steering/godot/GAME-DEV-INDEX.md`（不重复引擎官方文档，只收架构约束与 best practice）。
