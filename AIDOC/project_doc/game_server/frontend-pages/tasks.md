...
- [x] 1. 实现 DLC 管理页面
  - 创建 `projects/demo/game_server/game_server/frontend/src/views/game/dlc.vue`
...
- [x] 2. 实现玩家管理页面
  - 创建 `projects/demo/game_server/game_server/frontend/src/views/game/player.vue`
...
- [x] 3. 实现订单管理页面
  - 创建 `projects/demo/game_server/game_server/frontend/src/views/game/order.vue`
...
- [x] 4. 实现支付配置页面
  - 创建 `projects/demo/game_server/game_server/frontend/src/views/game/payment.vue`
...
- [x] 5. 实现 H5 页面管理
  - 创建 `projects/demo/game_server/game_server/frontend/src/views/game/h5.vue`
...
- [x] 6. 生成菜单初始化 SQL
  - 创建 `projects/demo/game_server/backend/config/menu_init.sql`
